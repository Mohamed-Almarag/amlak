      ...
      <div class="event-info">
        ...
        <div class="user-raing my-5">
          ...
          <div class="rating-info">
            <p class="d-flex">
              <span class="mr-2">{{ event.rate }}/5</span>
        ...
        <div class="user-reviews my-5" v-if="event.rateable">
          <h4 class="my-5 title">
            {{ $t('User Reviews') }}
          </h4>
          <div class="my-5">
            <div
              ...
              v-for="rating in event.rateable"
              :key="rating.id"
            >
              <div class="row">
...
export default {
  props: ['event', 'myComments','pageName'],
  data() {
    return {
      requestData: {
        comment: null,
  ...
  created() {
    console.log('this.myComments', this.myComments)
  },
}
</script>
