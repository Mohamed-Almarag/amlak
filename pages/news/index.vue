<template>
  <div>
    <div class="container-fluid">
      <ReusableSimbleCover :title="$t('News')" :img="imageCover" />
      <div class="">
          ...
          <div class="row">
            ...
            <aside class="col-lg-4">
              <div class="holder">
                ...
                <NewsRightSide :is-sidebar="isSidebar" :sideData="sideData" />
              </div>
            </aside>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getReviews() {
      return this.$store.dispatch('news/getReviews')
    },
    sliderData() {
      return this.$store.dispatch('news/newsSliderData')
    },
    newsAside() {
      return this.$store.dispatch('news/newsAside')
    },
  },
  computed: {
    news() {
    ...
    sliders() {
      return this.$store.state.news.Sliders
    },
    reviews() {
      return this.$store.state.news.Reviews
    },
    sideData() {
      return this.$store.state.news.Aside
    },
  },
}
</script>
